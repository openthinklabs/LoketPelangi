...
class ETcPdf
{
   ...
   public function __construct($orientation, $unit, $format, $unicode, $encoding)
   {
      ...
      if (is_string($format)) {
         if (!in_array($format, array('A3', 'A4', 'A5', 'Letter', 'Legal','FAKTUR_LOKET_PELANGI')))
            throw new CException(Yii::t('ETcPdf', "The format must be one of A3, A4, A5, Letter, Legal, or ''"));
      }
      else {
